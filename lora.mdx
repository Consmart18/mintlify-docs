...
<Steps>
  ...
  <Step title="Step 4">
    ...
    <Latex>Output = (W + A \times B) \times Input</Latex>
  </Step>
</Steps>

<img src="/images/LoRA.png" alt="Full-Parameter Fine-tuning vs LoRA Fine-tuning comparison diagram" />

*Full-Parameter Fine-tuning vs LoRA Fine-tuning ([source](https://www.geeksforgeeks.org/deep-learning/what-is-low-rank-adaptation-lora/))*
